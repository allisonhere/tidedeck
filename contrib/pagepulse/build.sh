...
# installed copy does not need this - the released app is built with its bundled
# plugins, and the binary travels with it.
set -eu
...
cd "$ROOT"
exec go build -o "$DIR/pagepulse" ./contrib/pagepulse
