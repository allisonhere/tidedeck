...
func (f *demoFeed) Weather(now time.Time) tideui.WeatherData {
	...
	return tideui.WeatherData{
		...
		Hourly: []tideui.ForecastPoint{
			{Label: "3PM", Temperature: 74, RainChance: 10},
			{Label: "6PM", Temperature: 70, RainChance: 15},
			{Label: "9PM", Temperature: 64, RainChance: 20},
			{Label: "12AM", Temperature: 61, RainChance: 12},
		},
